	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 uv_WallMask_1 = IN.ase_texcoord7.xy * _WallMask_1_ST.xy + _WallMask_1_ST.zw;
				...
				float2 uv_WallMask_2 = IN.ase_texcoord7.xy * _WallMask_2_ST.xy + _WallMask_2_ST.zw;
				...
				float3 Albedo = (( _GrungeDecalSwitch_2 )?( ( (( _GrungeDecalSwitch_1 )?( ( tex2DNode3 * lerpResult32 ) ):( lerpResult20 )) * lerpResult57 ) ):( lerpResult58 )).rgb;
...
/*ASEBEGIN
Version=18909
-3426;9;2956;1351;3592.787;979.7907;1.606366;True;True
...
ASEEND*/
//CHKSM=92340808BCE3ACAA4D927CAE3BD7FB63601D7EA3