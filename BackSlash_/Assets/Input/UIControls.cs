...
public partial class @UIControls: IInputActionCollection2, IDisposable
{
    ...
    ~@UIControls()
    {
        UnityEngine.Debug.Assert(!m_Common.enabled, "This will cause a leak and performance issues, UIControls.Common.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_Pause.enabled, "This will cause a leak and performance issues, UIControls.Pause.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_Menu.enabled, "This will cause a leak and performance issues, UIControls.Menu.Disable() has not been called.");
    }
